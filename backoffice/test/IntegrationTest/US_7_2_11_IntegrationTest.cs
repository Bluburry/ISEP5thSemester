...
{
	public class US_7_2_11_IntegrationTest
	{
		...
		public US_7_2_11_IntegrationTest()
		{
			_mockUnitOfWork = new ();
			_mockSpecRepo = new ();
			_mockLogRepo = new ();
		...
		[Fact]
		public async Task CreateSpecialization_Successful()
		{
		...
		[Fact]
		public async Task CreateSpecialization_UnSuccessful()
		{
			...
			var exception = await Assert.ThrowsAsync<ArgumentException>(async () =>
				await _ctrl.CreateSpecialization(_spec.ToDTO(), _token.ToDto().TokenId)
			);
